...
```bash
npm --prefix packages/module-sdk run generate:third-party-bindings
npm --prefix packages/module-sdk run generate:third-party-fixtures
```

## Golden vectors

Use fixtures in `packages/module-sdk/fixtures/third-party/v1/` to verify your
