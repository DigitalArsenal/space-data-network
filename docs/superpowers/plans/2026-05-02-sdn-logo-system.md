...
- Modify `webui/src/navigation/ipfs-logo.svg`: black SDN mark for light/upstream logo consumers.
- Modify `webui/src/navigation/ipfs-logo-text-horiz.svg` and `webui/src/navigation/ipfs-logo-text-vert.svg`: white SDN mark replacement for dark nav surfaces.
...
- Regenerate `desktop/assets/icons/tray/macos/*Template*.png`, `desktop/assets/icons/tray/others/*.png`, `desktop/assets/build/icon.ico`, `desktop/assets/build/icon.icns`, `webui/public/favicon.ico`, `webui/public/ipfs-logo-512-ice.png`.
