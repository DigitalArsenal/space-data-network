...
- SDN-owned upstream WebUI overlay assets.
- Upstream WebUI IPFS logo sources, manifest metadata, and public favicon/logo assets stay upstream-branded.
...
- Rebuild SDN JS UI because SDN-owned overlay and admin logo assets ship through that bundle.
