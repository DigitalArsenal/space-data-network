...
require (
	github.com/DigitalArsenal/spacedatastandards.org/lib/go v1.176.0
...
replace github.com/DigitalArsenal/spacedatastandards.org/lib/go => ./third_party/spacedatastandards-go
