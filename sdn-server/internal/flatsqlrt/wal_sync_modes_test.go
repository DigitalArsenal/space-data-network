...
//
// Measured when written: TRUNCATE+FULL 1315 rows/s, WAL+FULL 3840, and
// WAL+NORMAL 19550. The control store runs WAL+FULL — the free win — and
// NORMAL stays available as a product decision, not a silent one.
