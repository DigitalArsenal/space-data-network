		...
		"updates": [
			{
				...
				"manifest_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/linux/amd64/1.0.4/manifest.json",
				"carrier_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/linux/amd64/1.0.4/update.wasm"
			},
			{
				...
				"channel": "beta",
				"target": {"platform": "linux", "arch": "amd64", "kind": "cli-bundle"},
				"manifest_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/linux/amd64/1.0.5/manifest.json",
				"carrier_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/linux/amd64/1.0.5/update.wasm"
			},
			{
				...
				"manifest_url": "https://sdn.spaceaware.io/api/v1/updates/desktop/beta/linux/amd64/1.0.6/manifest.json",
				"carrier_url": "https://sdn.spaceaware.io/api/v1/updates/desktop/beta/linux/amd64/1.0.6/update.wasm"
			}
		]
	}`)
		...
		"updates": [
			{
				...
				"channel": "beta",
				"target": {"platform": "linux", "arch": "amd64", "kind": "cli-bundle"},
				"manifest_url": "http://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/linux/amd64/1.0.5/manifest.json",
				"carrier_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/linux/amd64/1.0.5/update.wasm"
			}
		]
	}`)
		...
		"updates": [
			{
				...
				"manifest_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/darwin/amd64/1.0.5/manifest.json",
				"carrier_url": "https://sdn.spaceaware.io/api/v1/updates/cli-bundle/beta/darwin/amd64/1.0.5/update.wasm"
			}
		]
	}`)
