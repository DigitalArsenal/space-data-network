	...
	return []staticRouteDecl{
		{
			...
			operation: openAPIObj{
				...
				"responses": openAPIObj{
					...
					"502": openAPIObj{"description": "Kubo could not calculate or pin the deterministic asset CID."},
					"503": openAPIObj{"description": "OIDC, ledger, or asset pin capability unavailable."},
