	...
	return []staticRouteDecl{
		{
			...
			operation: openAPIObj{
				...
				"responses": openAPIObj{
					...
					"409": openAPIObj{"description": "Candidate key conflicts with an existing asset reference."},
					"502": openAPIObj{"description": "Kubo returned an invalid or inconsistent deterministic asset CID."},
					"503": openAPIObj{"description": "OIDC, ledger, asset pin storage, or Kubo unavailable."},
					"507": openAPIObj{"description": "Node storage is below the configured reserve required for the upload."},
				},
			},
		},
		{
