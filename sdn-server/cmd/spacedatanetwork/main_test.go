...
func TestNodeSecurityPublicAPIRequestPolicy(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodGet, "/api/v1/nodes", true},
		{http.MethodGet, "/api/v1/nodes/12D3KooW/profile", true},
		{http.MethodHead, "/api/v1/nodes/12D3KooW/profile", true},
		{http.MethodGet, "/api/v1/modules", true},
		{http.MethodGet, "/api/v1/trust/edges", true},
		{http.MethodGet, "/api/v1/claims", true},
		{http.MethodHead, "/api/v1/claims", true},

		{http.MethodGet, "/api/v1/data/summary", false},
		{http.MethodGet, "/api/v1/nodes/12D3KooW", false},
		{http.MethodGet, "/api/v1/nodes/12D3KooW/profile/extra", false},
		{http.MethodPost, "/api/v1/nodes", false},
		{http.MethodPost, "/api/v1/modules", false},
		{http.MethodPost, "/api/v1/trust/edges", false},
		{http.MethodPost, "/api/v1/claims", false},
		{http.MethodPost, "/api/v1/claims/claim-id/verify", false},
		{http.MethodGet, "/api/v1/claims/claim-id/verify", false},
