// Moved from desktop/src/sdn-updater when the desktop app stopped carrying its
// own updater (2026-09-15). The fleet update lane (publish-fleet-update.mjs,
// sign-update-manifest.mjs, build-sdn-update-feed.js) and its tests are the
// consumers; the node's Go updater verifies what these functions produce.
