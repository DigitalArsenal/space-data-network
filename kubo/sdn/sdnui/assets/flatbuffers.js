// Vendored FlatBuffers runtime (Apache-2.0, google/flatbuffers) — bundled
// verbatim from space-data-module-sdk/src/vendor/flatbuffers into a single
// self-contained ES module (cross-file imports removed). This is the SAME
// FlatBuffers builder/reader the node-side SDS PIV bindings use, so a PIV
// request/response encoded here is byte-compatible with the node runtime.
// Do not edit by hand; regenerate from the SDK vendor sources.

// ===== flatbuffers/constants.js =====
export const SIZEOF_SHORT = 2;
export const SIZEOF_INT = 4;
export const FILE_IDENTIFIER_LENGTH = 4;
export const SIZE_PREFIX_LENGTH = 4;

// ===== flatbuffers/utils.js =====
export const int32 = new Int32Array(2);
export const float32 = new Float32Array(int32.buffer);
export const float64 = new Float64Array(int32.buffer);
export const isLittleEndian = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;

// ===== flatbuffers/encoding.js =====
export var Encoding;
(function (Encoding) {
