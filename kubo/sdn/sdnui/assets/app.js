  ...
  screen.innerHTML = `
    ...
    <div class="grid">
      ...
      <section class="panel span-4">
        ...
        <div class="actions">
          <button class="btn" disabled title="Not available in this build">EPM</button>
          <button class="btn" disabled title="Not available in this build">vCARD</button>
          <button class="btn" disabled title="Not available in this build">QR</button>
        </div>
        <p class="p-note">EPM / vCard / QR export is <span class="state-unavailable">unavailable</span> in this node console build.</p>
      </section>
