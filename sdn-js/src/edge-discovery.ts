...
export const DEFAULT_EDGE_RELAYS = getEnvRelays() ?? [
  ...
  '/dns4/relay1.digitalarsenal.io/tcp/443/wss/p2p/12D3KooWExampleRelay1',
  '/dns4/relay2.digitalarsenal.io/tcp/443/wss/p2p/12D3KooWExampleRelay2',
  // Development/testing relay (Tokyo) - configure via SDN_EDGE_RELAYS env var in production
  '/dns4/tokyo.relay.example.org/tcp/443/wss/p2p/16Uiu2HAkxKtJncDGfgtFpx4mNqtrzbBBrCZ8iaKKyKuEqEHuEz5J',
];
