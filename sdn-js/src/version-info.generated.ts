...
export const SUITE_VERSION = "1.0.3";
export const SPACEDATASTANDARDS_VERSION = "1.135.0";
export const FLATSQL_VERSION = "1.0.1";
export const HD_WALLET_WASM_VERSION = "2.0.20";
export const HD_WALLET_UI_VERSION = "2.0.20";
