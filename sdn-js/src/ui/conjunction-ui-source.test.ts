...
describe('SDN conjunction UI source contract', () => {
  it('registers an encrypted conjunction screen in the Svelte shell', async () => {
    ...
    expect(screen).toContain('resultChannelId');
    expect(screen).toContain('assessorPeerId');
    expect(screen).toContain('primaryProviderId');
    expect(screen).toContain('primarySourceName');
    expect(screen).toContain('primaryPnmCid');
    expect(screen).toContain('primaryQuery');
    expect(screen).toContain('secondaryProviderId');
    expect(screen).toContain('secondarySourceName');
    expect(screen).toContain('secondaryPnmCid');
    expect(screen).toContain('secondaryQuery');
    expect(screen).toContain('moduleId');
    expect(screen).toContain('moduleVersion');
    expect(screen).toContain('provenance');
