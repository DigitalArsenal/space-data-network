...
/**
 * SDN root keeps the upstream navbar behavior and only swaps branding.
 *
 * Synced base: webui/src/navigation/NavBar.js
 */
...
export const NavBar = ({ t }) => {
  const codeUrl = 'https://github.com/DigitalArsenal/space-data-network'
