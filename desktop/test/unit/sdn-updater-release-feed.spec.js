...
test.describe('SDN updater release feed', () => {
  test('builds deterministic SDN-owned desktop feed URLs', () => {
    ...
    expect(urls).toEqual({
      ...
      feedUrl: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64',
      indexUrl: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/index.json',
      manifestUrl: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/0.48.0/manifest.json',
      carrierUrl: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/0.48.0/update.wasm'
    })
  ...
  test('rejects non-SDN desktop application update feeds', () => {
    expect(() => assertSdnOwnedDesktopUpdateFeedUrl('https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64')).not.toThrow()
      ...
      updates: [
        {
          ...
          manifest_url: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/0.48.0/manifest.json',
          carrier_url: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/0.48.0/update.wasm'
        },
        {
          update_id: 'desktop-stable-2026-05-04',
          version: '0.47.1',
          ...
          wasm_hash: 'b'.repeat(64),
          signing_key_id: 'release-2026q2',
          manifest_url: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/0.47.1/manifest.json',
          carrier_url: 'https://updates.spacedatanetwork.org/desktop/stable/darwin/arm64/0.47.1/update.wasm'
        }
      ]
    })
  })
  ...
  test('indexes non-desktop SDN payloads under their target-kind feed path', () => {
    ...
    expect(index.updates[0]).toMatchObject({
      ...
      manifest_url: 'https://updates.spacedatanetwork.org/kubo-runtime/stable/darwin/arm64/0.39.1/manifest.json',
      carrier_url: 'https://updates.spacedatanetwork.org/kubo-runtime/stable/darwin/arm64/0.39.1/update.wasm'
    })
  })
