...
test('desktop tray About links point at SDN product pages', () => {
  ...
  expect(source).toContain("shell.openExternal('https://github.com/DigitalArsenal/space-data-network/issues/new?labels=i18n')")
  expect(source).toContain('github.com/ipfs/kubo/releases')
  expect(source).not.toContain('transifex.com/ipfs')
